...
from .mixins import CategoryDetailMixins, CartMixin
...
class CategoryDetailView(CartMixin, CategoryDetailMixins, DetailView):
    model = Category
...
class ProductDetailView(CartMixin, CategoryDetailMixins, DetailView):
